...
$sql = "select * from user where id= '".$_SESSION['loginchecksession']."' and password='".md5($oldpassword )."'";
$q = $conn->query($sql);
if($q->num_rows>0)
{

$sql = "update user set  password = '".md5($newpassword)."' WHERE id = '".$_SESSION['loginchecksession']."'";
$r = $conn->query($sql);
