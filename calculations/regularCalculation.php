...
global $newAdvance_status, $paid_in_cash, $newDue_status, $paid_in_Cheque;
    ...
    if($emp_type == "Casual"){
      ...
      $q4 = $conn->query($query4);
        while($row4 = $q4->fetch_assoc()) {
          ...
          else if($row4['d_method'] == "Cheque"){
            $paid_in_Cheque = $paid_in_Cheque + $row4['d_amount'];
          }
        ...
        if($advance_status=="1"){
          ...
          if($advanceSalary>0){
            $message2 = "* $advanceSalary Rupees Will reduce next month'";
            $advance_status = "1";
            $newAdvance_status = "1";
          }
          else{
